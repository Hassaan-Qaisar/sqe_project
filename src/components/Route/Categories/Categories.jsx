...
const Categories = () => {
  ...
  return (
    <>
      <div className={`${styles.section} hidden sm:block`} data-testid="branding-section">
      ...
      <div className={`${styles.section} bg-white p-6 rounded-lg mb-12`} id="categories" data-testid="categories-section">
